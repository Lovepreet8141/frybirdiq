 ...
 *
 * This middleware only *refreshes*. It does not authorize — §41 requires that
 * server-side at the point of use, and a middleware matcher is a routing rule,
 * not a permission check. The `/app` layout does the real gate.
 */
