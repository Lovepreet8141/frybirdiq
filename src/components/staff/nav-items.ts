  ...
  const groups: NavGroup[] = [
    {
      ...
      items: [
          ...
          ? [
              {
                ...
                label: "Overview",
                icon: LayoutGrid,
                exclude: ["/app/iq/menu", "/app/iq/live", "/app/iq/kitchen", "/app/iq/activity", "/app/iq/alerts", "/app/iq/brief", "/app/iq/channels", "/app/iq/products", "/app/iq/pnl", "/app/iq/expenses", "/app/iq/rewards"],
              },
            ]
          : []),
        ...
        ...(canSeeOrders ? [{ href: "/app/orders", label: "Orders", icon: ClipboardList, exclude: ["/app/orders/history"] }] : []),
        ...(canSeeOrders ? [{ href: "/app/orders/history", label: "Order history", icon: History }] : []),
        ...(canSeePos ? [{ href: "/app/pos", label: "POS", icon: ShoppingBag }] : []),
        ...(canSeeKitchen ? [{ href: "/app/kds", label: "Kitchen", icon: ChefHat }] : []),
        ...(canSeeAnalytics || canSeeKitchen ? [{ href: "/app/iq/kitchen", label: "Kitchen analytics", icon: Gauge }] : []),
